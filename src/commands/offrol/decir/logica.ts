...
const defolt = [
    ...
    "NO CHUPEN SU PROPIA PIJA\nNO se siente como si te chuparan la pija SE SIENTE como si estuvieras chupando una pija \n REPITO, NO SE AUTOCHUPEN LA PIJA",
    ...
    "Martinez (Martinez), Molina (Molina), Romero (Romero), Senesi (Senesi), Tagliafico (Tagliafico), Macalister (Macalister), Paredes (Paredes), Fernandez (Fernandez), Alvarez (Alvarez), Gonzales (Gonzales). Respeten los rangos, el rey ya llegó: Messi, Messi, Messi, Messi, Messi. Es Argentina. Arge-arge-arge-arge Es Argentina. Arge-arge-arge",
    "Tengo una piedra en el riñón\nDicen que voy a morir\nEl doctor me delató\nQue me entró por la nariz",
    "Hay cinco mujeres peligrosas ⚠️ que debes evitar, mi pinche batman. al tiro cabron. Te escucho mi sensei 🦇🥷👂 porque la gatubela 🐱👩 anda de cabrona. Número 1: una mujer rodeada de muchos hombres, a quienes ella llama sus amigos, es una tramposa 😲, y una mentirosa patológica 😨\nNúmero 2: Una mujer que te quiere por tu dinero 💸 🫰.  Se que estás cagado de varo Batman 🦇 🤑 💵 . Así que te digo, esas viejas no te aportarán ningún valor. Ella es un vampiro financiero 🧛‍♀️ 📉  parásito 🪱 🦠 . Ella te arruinará 😨 ⚠️ 🏚️\nDices puras verdades cabrón. 🧐 👏 🙌  Por eso me tienes que seguir 🫵 🤝 🔔 mi batman. Pero también toma en cuenta el número 3: Una mujer que no acepta instrucciones, corrección e instrucciones tuyas 🛑. Debes de mandar en la relación, cabrón 😎, y esas viejas son unas bastardas arrogantes 👑. Ella te arruinará 💣😰 .",
    ...
    "Che me gusta tu remera, es retro? retrolazo"
];
